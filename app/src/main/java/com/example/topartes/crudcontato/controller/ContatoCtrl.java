package com.example.topartes.crudcontato.controller;
...
import com.example.topartes.crudcontato.adapter.DBAdapter;
import com.example.topartes.crudcontato.model.Contato;

import java.util.ArrayList;
import java.util.List;

public class ContatoCtrl extends DBAdapter {

    public ContatoCtrl (Context context){
        super(context);
    }
    ...
    public boolean create(Contato contato){
        ...
        boolean isCreaete = db.insert("contato", null, values)> 0;
        db.close();
    ...
    public Contato idSelectContato(int contatoID){
